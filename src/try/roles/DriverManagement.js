      ...
      <main className="flex-grow flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-4xl">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-6">
            <input
              className="w-full sm:max-w-sm rounded-xl border border-gray-200 px-4 py-2 focus:outline-none focus:ring focus:ring-indigo-100 text-lg"
                ...
                <tr>
                  {["name", "phone", "vehicle", "plate", "status", "rating", "trips"].map(
                    (key) => (
                      <th
                        key={key}
                        className="px-4 py-3 text-left text-sm font-semibold uppercase tracking-wider text-gray-600"
                      >
                        <button
